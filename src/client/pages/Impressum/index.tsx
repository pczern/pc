...
const Impressum: StatelessComponent<Props> = () => (
  <Page noCenter={true}>
    <BoxedContainer>
    <Helmet>
          <meta charSet="utf-8" />
      ...
      <p>Philipp Mustermann<br />
      Software Engineer &amp; Consultant<br />
      Langgasse 172<br />
      67454 Hassloch</p>

      <h2>Kontakt</h2>
      <p>Telefon: +49 176 84788528<br />
      E-Mail: philipp.czernitzki@gmail.com</p>
